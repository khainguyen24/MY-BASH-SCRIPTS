...
CHECK_FILE_PARAM "/opt/jboss/default/standalone/configuration/standalone-full-lab.xml" "${LOG_PATH}" "ITWOAR-16044" "Update standalone XML with new wlmerge bridge settings" "state='Linked' OR state='Purged'"
...
CHECK_MODE_FILE_PARAM "/opt/jboss/jboss-eap-7.0/modules/com/leidos/login/main/sso.properties" ${LOG_PATH} "ITWOAR-16249" "Change SAML singleSignOnServiceLocation for J mode servers" "Present" "J-MODE" "sso.saml.singleSignOnServiceLocation=/sts-mock/startSsoX509/nocsv"
CHECK_MODE_FILE_PARAM "/opt/jboss/jboss-eap-7.0/modules/com/leidos/login/main/sso.properties" ${LOG_PATH} "ITWOAR-16249" "Change SAML singleSignOnServiceLocation for J mode servers" "Absent" "S-MODE" "sso.saml.singleSignOnServiceLocation=/sts-mock/startSsoX509/nocsv"

## ITWOAR-16241 Add ingest-solr.useBatchQueue to biometrics.properties
CHECK_FILE_PARAM "/opt/jboss/jboss-eap-7.0/modules/mil/army/inscom/biometrics/resources/main/biometrics.properties" ${LOG_PATH} "ITWOAR-16241" "Add ingest-solr.useBatchQueue to biometrics.properties" 'ingest-solr.useBatchQueue=false'
