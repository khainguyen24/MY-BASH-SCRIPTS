...
├── atp_scores_compare - (BIR ATP_BIDS.TXT uses \"-\" in the \"B28JM-R3J9\" where I2ar does not \"B28JMR3J9\". Remove the dash in the ATP_BIDS.TXT and patternFile. Example: for testing: [sed 's/-//g' ATP_BIDS_dash_removed.TXT] for real:[sed -i 's/-//g' ATP_BIDS_dash_removed.TXT] )
│   ├── ATP_BIDS.TXT
│   └── atp_scores.txt
